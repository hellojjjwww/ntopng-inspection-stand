...
Разработанный стенд обеспечивает воспроизводимое развертывание системы сетевой инспекции и может использоваться для учебного анализа сетевых потоков, проверки политик обнаружения и подготовки материалов по мониторингу Linux-инфраструктуры.
